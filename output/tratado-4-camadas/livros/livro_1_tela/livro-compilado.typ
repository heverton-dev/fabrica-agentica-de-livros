...
#set page(
  ...
  header: context {
    if counter(page).get().first() > 1 {
      ...
      align(center, "Camada 1 — TELA: O Painel de Visibilidade e Governança de Contexto")
    }
  },
  footer: context {
    set text(size: 9pt)
...
#page(header: none, footer: none, numbering: none)[
  ...
  #align(center)[
    ...
    #v(3.5cm)
    #text(font: ("Inter", "Liberation Sans", "Arial"), size: 22pt, weight: "bold", fill: cor.primaria)[Camada 1 — TELA: O Painel de Visibilidade e Governança de Contexto]
      ]
  #v(4cm)
    ...
    #block(
      ...
      #grid(
        ...
        [
          ...
          #pad(left: 0.8cm)[
            Camada 1 — TELA: O Painel de Visibilidade e Governança de Contexto \/ Heverton Eduardo Peres. --
            São Paulo : Fábrica Agêntica de Livros,
            2026.
          ]
          #pad(left: 0.8cm)[57 p. ; 21 cm.]
                    #v(0.15cm)
...
// ── CONTRACAPA ────────────────────────────────────────────────────
  ...
  page(fill: cor.primaria, margin: 0cm, header: none, footer: none, numbering: none)[
    ...
    #place(top + left, dx: 2.5cm, dy: 4cm, block(width: 14.5cm)[
      #text(size: 18pt, weight: "bold", fill: cor.destaque)[Camada 1 — TELA: O Painel de Visibilidade e Governança de Contexto]
      #v(1cm)
      #text(size: 11.5pt, fill: white)[O guia definitivo da Camada TELA na Fábrica Agêntica. Aprenda a governar a interface de entrada de LLMs, dominar os 4 Breakpoints de Cache com 98% de desconto real, aplicar as 18 Regras Sagradas, realizar busca híbrida com AST e eliminar a amnésia e o ruído em sessões de código.]
      #v(1.2cm)
